  ...
  return (
    <footer className="font-medium p-3 bg-primary text-white text-sm">
      ...
      <p className="text-center p-3">
        &copy; {currentYear} Desa Karangbendo. All rights reserved.
      </p>
    </footer>
  );
}
