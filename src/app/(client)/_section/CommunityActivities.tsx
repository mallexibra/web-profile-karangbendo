    ...
    return (
        <div id="kegiatanmasyarakat">
            ...
            <ContainerClient classNames="md:pt-24 pt-12">
                ...
                <div className="mt-5 flex flex-col md:flex-row justify-center md:justify-start items-center md:items-start gap-2" data-aos="fade-down">
