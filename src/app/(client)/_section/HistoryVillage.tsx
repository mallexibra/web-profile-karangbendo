        ...
        <div id="sejarahdesa">
            <ContainerClient classNames="md:pt-24 pt-12">
                ...
                <div className="flex flex-col md:flex-row gap-3 mt-3">
                    <Image data-aos="fade-right" src="/assets/village-profile/karangbendo.png" width={800} height={600} className="rounded-md md:w-1/3 w-full object-cover" alt="Desa Karangbendo"/>
