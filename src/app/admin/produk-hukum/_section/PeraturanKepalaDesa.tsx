  ...
  const fetchData = async () => {
    try {
      ...
      const data = dataTemporary.filter(
        (legal: LegalProduct) => legal.type == 'village_head_regulation',
      );
    ...
    try {
      ...
      if (response.status) {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Sukses!',
          text: 'Sukses delete data peraturan kepala desa',
        });
        fetchData();
      } else {
        close();
    ...
    try {
      ...
      if (response.status) {
        ...
        Swal.fire({
          icon: 'success',
          title: 'Sukses!',
          text: `Sukses ${id ? 'edit' : 'tambah'} data peraturan kepala desa`,
        });
        fetchData();
      } else {
        close();
